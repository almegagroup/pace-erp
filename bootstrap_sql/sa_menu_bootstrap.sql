...
BEGIN
  ...
  VALUES
    ...
    ('SA_WORK_CONTEXT_MASTER','SA_WORK_CONTEXT_MASTER','Work Context Master','Create manual runtime work scopes such as PROD_POWDER, QA_ADMIX, SCM_OPERATIONS, MGMT_ALL, or AUDIT_ALL.','/sa/work-contexts','PAGE','SA',true,4,true,now(),'SYSTEM'),
    ('SA_PROJECT_MASTER','SA_PROJECT_MASTER','Project Master','Register business projects before mapping modules or page resources.','/sa/project-master','PAGE','SA',true,5,true,now(),'SYSTEM'),
    ('SA_PROJECT_MANAGE','SA_PROJECT_MANAGE','Project Manage','Review saved projects and keep project metadata clean.','/sa/projects/manage','PAGE','SA',true,6,true,now(),'SYSTEM'),
    ('SA_COMPANY_PROJECT_MAP','SA_COMPANY_PROJECT_MAP','Project Company Map','Decide which companies can use each business project.','/sa/projects/map','PAGE','SA',true,7,true,now(),'SYSTEM'),
    ('SA_MODULE_MASTER','SA_MODULE_MASTER','Module Master','Create and maintain business modules under the right project foundation.','/sa/module-master','PAGE','SA',true,8,true,now(),'SYSTEM'),
    ('SA_COMPANY_MODULE_MAP','SA_COMPANY_MODULE_MAP','Company Modules','Enable exact modules per company after projects and modules are ready.','/sa/acl/company-modules','PAGE','SA',true,9,true,now(),'SYSTEM'),
