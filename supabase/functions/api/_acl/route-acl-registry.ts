...
const EXACT_ROUTE_ACL: Record<string, RouteAclMeta> = {
  ...
  // ── Procurement: CSN ─────────────────────────────────────────────────────
  "GET:/api/procurement/csns": {
    skipAcl: false,
    resourceCode: "PROC_CSN_TRACKER",
    action: "VIEW",
  },
  "GET:/api/procurement/csns/available-for-sto": {
    skipAcl: false,
    resourceCode: "PROC_CSN_TRACKER",
    action: "VIEW",
  },
  "GET:/api/procurement/tracker": {
    skipAcl: false,
    resourceCode: "PROC_CSN_TRACKER",
    action: "VIEW",
  },
  "GET:/api/procurement/tracker/layouts": {
    skipAcl: false,
    resourceCode: "PROC_CSN_TRACKER",
    action: "VIEW",
  },
  "POST:/api/procurement/tracker/layouts": {
    skipAcl: false,
    resourceCode: "PROC_CSN_TRACKER",
    action: "WRITE",
  },
  "GET:/api/procurement/alerts/lc-count": {
    skipAcl: false,
    resourceCode: "PROC_CSN_ALERTS",
    action: "VIEW",
  },
  "GET:/api/procurement/alerts/lc": {
    skipAcl: false,
    resourceCode: "PROC_CSN_ALERTS",
    action: "VIEW",
  },
  "GET:/api/procurement/alerts/vessel-booking-count": {
    skipAcl: false,
    resourceCode: "PROC_CSN_ALERTS",
    action: "VIEW",
  },
  "GET:/api/procurement/alerts/vessel-booking": {
    skipAcl: false,
    resourceCode: "PROC_CSN_ALERTS",
    action: "VIEW",
  },
  "GET:/api/procurement/alerts/counts": {
    skipAcl: false,
    resourceCode: "PROC_CSN_ALERTS",
    action: "VIEW",
  },
  ...
  "GET:/api/procurement/po-order-groups": {
    skipAcl: false,
    resourceCode: "PROC_PO_ORDER_APPROVALS",
    action: "VIEW",
  },
  "GET:/api/procurement/print-groups": {
    skipAcl: false,
    resourceCode: "PROC_PO_STO_PRINT",
    action: "VIEW",
  },
  "POST:/api/procurement/print-groups/log": {
    skipAcl: false,
    resourceCode: "PROC_PO_STO_PRINT",
    action: "WRITE",
  },
  "GET:/api/procurement/po-filter-options": {
    skipAcl: false,
    resourceCode: "PROC_PO_LIST",
    action: "VIEW",
  },
  ...
  "GET:/api/procurement/materials/uom-conversion": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_LIST",
    action: "VIEW",
  },

  // ── Procurement: Gate Entry ───────────────────────────────────────────────
  "GET:/api/procurement/gate-entries": {
    skipAcl: false,
    resourceCode: "PROC_GATE_ENTRY_LIST",
    action: "VIEW",
  },
  "POST:/api/procurement/gate-entries": {
    skipAcl: false,
    resourceCode: "PROC_GATE_ENTRY_CREATE",
    action: "WRITE",
  },
  "GET:/api/procurement/gate-entries/open-csns": {
    skipAcl: false,
    resourceCode: "PROC_GATE_ENTRY_CREATE",
    action: "VIEW",
  },
  "GET:/api/procurement/gate-entries/open-pos": {
    skipAcl: false,
    resourceCode: "PROC_GATE_ENTRY_CREATE",
    action: "VIEW",
  },
  "GET:/api/procurement/gate-entries/open-stos": {
    skipAcl: false,
    resourceCode: "PROC_GATE_ENTRY_CREATE",
    action: "VIEW",
  },
  "GET:/api/procurement/gate-entries/by-number": {
    skipAcl: false,
    resourceCode: "PROC_GATE_EXIT",
    action: "VIEW",
  },
  "POST:/api/procurement/gate-exits/inbound": {
    skipAcl: false,
    resourceCode: "PROC_GATE_ENTRY_CREATE",
    action: "WRITE",
  },
  "GET:/api/procurement/gate-report": {
    skipAcl: false,
    resourceCode: "PROC_GATE_REPORT",
    action: "VIEW",
  },
  ...
  "GET:/api/procurement/grns/ge-lines": {
    skipAcl: false,
    resourceCode: "PROC_GRN_LIST",
    action: "VIEW",
  },
  ...
  "GET:/api/procurement/qa-documents": {
    skipAcl: false,
    resourceCode: "PROC_QA_QUEUE",
    action: "VIEW",
  },
  "GET:/api/procurement/qa-test-methods": {
    skipAcl: false,
    resourceCode: "PROC_QA_QUEUE",
    action: "VIEW",
  },
  "POST:/api/procurement/qa-test-methods": {
    skipAcl: false,
    resourceCode: "PROC_QA_QUEUE",
    action: "WRITE",
  },
  "GET:/api/procurement/qa-category-test-config": {
    skipAcl: false,
    resourceCode: "PROC_QA_QUEUE",
    action: "VIEW",
  },
  "POST:/api/procurement/qa-category-test-config": {
    skipAcl: false,
    resourceCode: "PROC_QA_QUEUE",
    action: "WRITE",
  },
  ...
  "GET:/api/procurement/invoice-verifications": {
    skipAcl: false,
    resourceCode: "PROC_IV_LIST",
    action: "VIEW",
  },
  "POST:/api/procurement/invoice-verifications": {
    skipAcl: false,
    resourceCode: "PROC_IV_CREATE",
    action: "WRITE",
  },
  "GET:/api/procurement/invoice-verifications/blocked": {
    skipAcl: false,
    resourceCode: "PROC_BLOCKED_IV_LIST",
    action: "VIEW",
  },

  // ── Procurement: Landed Cost ─────────────────────────────────────────────
  "GET:/api/procurement/landed-costs": {
    skipAcl: false,
    resourceCode: "PROC_LC_LIST",
    action: "VIEW",
  },
  "POST:/api/procurement/landed-costs": {
    skipAcl: false,
    resourceCode: "PROC_LC_LIST",
    action: "WRITE",
  },
  ...
  "GET:/api/procurement/ac01/grns": {
    skipAcl: false,
    resourceCode: "PROC_IV_LIST",
    action: "VIEW",
  },
  "GET:/api/procurement/ac01/deduction-types": {
    skipAcl: false,
    resourceCode: "PROC_IV_LIST",
    action: "VIEW",
  },
  "POST:/api/procurement/ac01/deduction-types": {
    skipAcl: false,
    resourceCode: "PROC_IV_LIST",
    action: "WRITE",
  },
  ...
  "GET:/api/procurement/ptos": {
    skipAcl: false,
    resourceCode: "PROC_PLANT_TRANSFER_LIST",
    action: "VIEW",
  },
  "POST:/api/procurement/ptos": {
    skipAcl: false,
    resourceCode: "PROC_PLANT_TRANSFER_LIST",
    action: "WRITE",
  },
  "POST:/api/procurement/sloc-transfer": {
    skipAcl: false,
    resourceCode: "PROC_PLANT_TRANSFER_LIST",
    action: "WRITE",
  },
  ...
  "GET:/api/procurement/rtvs": {
    skipAcl: false,
    resourceCode: "PROC_RTV_LIST",
    action: "VIEW",
  },
  "POST:/api/procurement/rtvs": {
    skipAcl: false,
    resourceCode: "PROC_RTV_CREATE",
    action: "WRITE",
  },
  "GET:/api/procurement/debit-notes": {
    skipAcl: false,
    resourceCode: "PROC_DEBIT_NOTE_LIST",
    action: "VIEW",
  },
  "POST:/api/procurement/debit-notes": {
    skipAcl: false,
    resourceCode: "PROC_DEBIT_NOTE_LIST",
    action: "WRITE",
  },
  "GET:/api/procurement/exchange-refs": {
    skipAcl: false,
    resourceCode: "PROC_EXCHANGE_REF_LIST",
    action: "VIEW",
  },
  "POST:/api/procurement/exchange-refs": {
    skipAcl: false,
    resourceCode: "PROC_EXCHANGE_REF_LIST",
    action: "WRITE",
  },
  ...
  // ── Procurement: STO ─────────────────────────────────────────────────────
  "GET:/api/procurement/stos": {
    skipAcl: false,
    resourceCode: "PROC_STO_LIST",
    action: "VIEW",
  },
  "GET:/api/procurement/stos/last-payment-term": {
    skipAcl: false,
    resourceCode: "PROC_STO_CREATE",
    action: "VIEW",
  },
  "POST:/api/procurement/stos": {
    skipAcl: false,
    resourceCode: "PROC_STO_CREATE",
    action: "WRITE",
  },
  ...
  // ── Procurement: Sales ───────────────────────────────────────────────────
  "GET:/api/procurement/sales-orders": {
    skipAcl: false,
    resourceCode: "PROC_SO_LIST",
    action: "VIEW",
  },
  // SO05 Sales Return. Accounts and Stores/Logistics receive the same menu grants.
  "GET:/api/procurement/sales-returns": {
    skipAcl: false,
    resourceCode: "PROC_SALES_RETURN_LIST",
    action: "VIEW",
  },
  "POST:/api/procurement/sales-returns": {
    skipAcl: false,
    resourceCode: "PROC_SALES_RETURN_LIST",
    action: "WRITE",
  },
  "GET:/api/procurement/sales-returns/pending-invoices": {
    skipAcl: false,
    resourceCode: "PROC_SALES_RETURN_LIST",
    action: "VIEW",
  },
  "POST:/api/procurement/sales-returns/invoice-detail": {
    skipAcl: false,
    resourceCode: "PROC_SALES_RETURN_LIST",
    action: "EDIT",
  },
  "GET:/api/procurement/sales-returns/batch-options": {
    skipAcl: false,
    resourceCode: "PROC_SALES_RETURN_LIST",
    action: "VIEW",
  },
  "GET:/api/procurement/sales-returns/repack-sku-options": {
    skipAcl: false,
    resourceCode: "PROC_SALES_RETURN_LIST",
    action: "VIEW",
  },
  "GET:/api/procurement/sales-returns/pending-strokes": {
    skipAcl: false,
    resourceCode: "PROD_STROKE_MASTER",
    action: "VIEW",
  },
  "GET:/api/procurement/sales-returns/pending-genealogy": {
    skipAcl: false,
    resourceCode: "PROC_SALES_RETURN_LIST",
    action: "VIEW",
  },
  "GET:/api/procurement/sales-returns/pending-process-entries": {
    skipAcl: false,
    resourceCode: "PROD_OLD_PROCESS_PO",
    action: "VIEW",
  },
  "GET:/api/procurement/sales-returns/pending-packing-entries": {
    skipAcl: false,
    resourceCode: "PROD_OLD_PACKING_PO",
    action: "VIEW",
  },
  "POST:/api/procurement/sales-orders": {
    skipAcl: false,
  ...
  "POST:/api/procurement/sales-orders-v2": {
    skipAcl: false,
    resourceCode: "PROC_SO_CREATE",
    action: "WRITE",
  },
  ...
  "GET:/api/procurement/sales-orders/fg-sku-options": {
    skipAcl: false,
    resourceCode: "PROC_SO_CREATE",
    action: "WRITE",
  },
  "GET:/api/procurement/sales-orders/sfg-material-options": {
    skipAcl: false,
    resourceCode: "PROC_SO_CREATE",
    action: "WRITE",
  },
  "GET:/api/procurement/sales-orders/stroke-check-options": {
    skipAcl: false,
    resourceCode: "PROC_SO_CREATE",
    action: "WRITE",
  },
  "GET:/api/procurement/sales-orders/address-options": {
    skipAcl: false,
    resourceCode: "PROC_SO_CREATE",
    action: "WRITE",
  },
  ...
  "GET:/api/procurement/so-map/so-list": {
    skipAcl: false,
    resourceCode: "PROC_SO_LIST",
    action: "VIEW",
  },
  "GET:/api/procurement/so-map/fo-options": {
    skipAcl: false,
    resourceCode: "PROC_SO_LIST",
    action: "VIEW",
  },
  "GET:/api/procurement/so-map/address-options": {
    skipAcl: false,
    resourceCode: "PROC_SO_LIST",
    action: "VIEW",
  },
  "POST:/api/procurement/so-map/map-fo": {
    skipAcl: false,
    resourceCode: "PROC_SO_LIST",
    action: "EDIT",
  },
  "POST:/api/procurement/so-map/map-address": {
    skipAcl: false,
    resourceCode: "PROC_SO_LIST",
    action: "EDIT",
  },
  "POST:/api/procurement/so-map/map-depot": {
    skipAcl: false,
    resourceCode: "PROC_SO_LIST",
    action: "EDIT",
  },
  "POST:/api/procurement/so-map/save-group": {
    skipAcl: false,
    resourceCode: "PROC_SO_LIST",
    action: "EDIT",
  },
  ...
  "GET:/api/procurement/delivery-orders": {
    skipAcl: false,
    resourceCode: "PROC_DO_LIST",
    action: "VIEW",
  },
  "POST:/api/procurement/delivery-orders": {
    skipAcl: false,
    resourceCode: "PROC_DO_CREATE",
    action: "WRITE",
  },
  "GET:/api/procurement/delivery-orders/source-documents": {
    skipAcl: false,
    resourceCode: "PROC_DO_CREATE",
    action: "VIEW",
  },
  "GET:/api/procurement/delivery-orders/source-lines": {
    skipAcl: false,
    resourceCode: "PROC_DO_CREATE",
    action: "VIEW",
  },
  "GET:/api/procurement/delivery-orders/storage-locations": {
    skipAcl: false,
    resourceCode: "PROC_DO_CREATE",
    action: "VIEW",
  },
  "GET:/api/procurement/delivery-orders-v2/add-so-options": {
    skipAcl: false,
    resourceCode: "PROC_DO_CREATE",
    action: "VIEW",
  },
  "GET:/api/procurement/delivery-orders-v2/add-sto-options": {
    skipAcl: false,
    resourceCode: "PROC_DO_CREATE",
    action: "VIEW",
  },
  "GET:/api/procurement/delivery-orders-v2/storage-options": {
    skipAcl: false,
    resourceCode: "PROC_DO_CREATE",
    action: "VIEW",
  },
  "POST:/api/procurement/delivery-orders-v2": {
    skipAcl: false,
    resourceCode: "PROC_DO_CREATE",
    action: "WRITE",
  },
  "GET:/api/procurement/sales-invoices": {
    skipAcl: false,
    resourceCode: "PROC_INV_LIST",
    action: "VIEW",
  },
  "POST:/api/procurement/sales-invoices": {
    skipAcl: false,
    resourceCode: "PROC_INV_LIST",
    action: "WRITE",
  },
  "GET:/api/procurement/dispatch-report": {
    skipAcl: false,
    resourceCode: "PROC_DISPATCH_REPORT",
    action: "VIEW",
  },
  "GET:/api/procurement/batch-costing-report": {
    skipAcl: false,
    resourceCode: "ACC_BATCH_COSTING_REPORT",
    action: "VIEW",
  },
  "GET:/api/procurement/reco-data": {
    skipAcl: false,
    resourceCode: "ACC_RECO_DATA",
    action: "VIEW",
  },
  "GET:/api/procurement/manual-costing-rows": {
    skipAcl: false,
    resourceCode: "ACC_MANUAL_COSTING_RATE",
    action: "VIEW",
  },
  ...
  "GET:/api/procurement/additional-cost-categories": {
    skipAcl: false,
    resourceCode: "PROC_INV_LIST",
    action: "VIEW",
  },
  "POST:/api/procurement/additional-cost-categories": {
    skipAcl: false,
    resourceCode: "PROC_INV_LIST",
    action: "WRITE",
  },
  ...
  "GET:/api/procurement/location-transfer-requests": {
    skipAcl: false,
    resourceCode: "PROC_LOC_TRANSFER_REQ",
    action: "VIEW",
  },
  "POST:/api/procurement/location-transfer-requests": {
    skipAcl: false,
    resourceCode: "PROC_LOC_TRANSFER_REQ",
    action: "WRITE",
  },
  "POST:/api/procurement/location-transfer-availability-preview": {
    skipAcl: false,
    resourceCode: "PROC_LOC_TRANSFER_REQ",
    action: "WRITE",
  },
  "GET:/api/procurement/location-transfer-workbench": {
    skipAcl: false,
    resourceCode: "PROC_LOC_TRANSFER_POST",
    action: "VIEW",
  },
  "POST:/api/procurement/location-transfer-postings": {
    skipAcl: false,
    resourceCode: "PROC_LOC_TRANSFER_POST",
    action: "WRITE",
  },
  ...
  "GET:/api/procurement/machine-distribution/unassigned": {
    skipAcl: false,
    resourceCode: "PROC_LOC_TRANSFER_POST",
    action: "VIEW",
  },
  "POST:/api/procurement/machine-distribution/assign": {
    skipAcl: false,
    resourceCode: "PROC_LOC_TRANSFER_POST",
    action: "WRITE",
  },
  "GET:/api/procurement/stock-status-change/balance": {
    skipAcl: false,
    resourceCode: "PROD_STOCK_STATUS_CHANGE",
    action: "VIEW",
  },
  ...
  "GET:/api/procurement/stock-status-change/postings": {
    skipAcl: false,
    resourceCode: "PROD_STOCK_STATUS_CHANGE",
    action: "VIEW",
  },
  ...
  "GET:/api/procurement/physical-inventory-differences": {
    skipAcl: false,
    resourceCode: "PROC_PI_DIFFERENCES",
    action: "VIEW",
  },
  ...
  "GET:/api/procurement/physical-inventory-material-locations": {
    skipAcl: false,
    resourceCode: "PROC_PI_LIST",
    action: "EDIT",
  },
  ...
  "GET:/api/procurement/physical-inventory-resolve": {
    skipAcl: false,
    resourceCode: "PROC_PI_LIST",
    action: "VIEW",
  },
  ...
  "GET:/api/procurement/physical-inventory-resolve-count": {
    skipAcl: false,
    resourceCode: "PROC_PI_COUNT_ENTRY",
    action: "VIEW",
  },
  "GET:/api/procurement/physical-inventory-resolve-recount": {
    skipAcl: false,
    resourceCode: "PROC_PI_RECOUNT",
    action: "VIEW",
  },
  ...
  "GET:/api/procurement/opening-stock": {
    skipAcl: false,
    resourceCode: "PROC_OPENING_STOCK_LIST",
    action: "VIEW",
  },
  ...
  "GET:/api/procurement/opening-stock/by-number": {
    skipAcl: false,
    resourceCode: "PROC_OPENING_STOCK_APPROVAL",
    action: "VIEW",
  },
  "POST:/api/procurement/opening-stock/recalculate-valuation": {
    skipAcl: false,
    resourceCode: "PROC_OPENING_STOCK_APPROVAL",
    action: "APPROVE",
  },
  ...
  "GET:/api/procurement/stock-ledger": {
    skipAcl: false,
    resourceCode: "PROC_STOCK_LEDGER",
    action: "VIEW",
  },
  "GET:/api/procurement/stock-ledger/machine-wise": {
    skipAcl: false,
    resourceCode: "PROC_STOCK_LEDGER",
    action: "VIEW",
  },
  "GET:/api/procurement/stock-ledger/movement-types": {
    skipAcl: false,
    resourceCode: "PROC_STOCK_LEDGER",
    action: "VIEW",
  },
  "GET:/api/procurement/stock-ledger/batch-search": {
    skipAcl: false,
    resourceCode: "PROC_STOCK_LEDGER",
    action: "VIEW",
  },
  "GET:/api/procurement/stock-ledger/po-search": {
    skipAcl: false,
    resourceCode: "PROC_STOCK_LEDGER",
    action: "VIEW",
  },
  "GET:/api/procurement/report-layouts": {
    skipAcl: false,
    resourceCode: "PROC_STOCK_LEDGER",
    action: "VIEW",
  },
  ...
  "POST:/api/procurement/report-layouts": {
    skipAcl: false,
    resourceCode: "PROC_STOCK_LEDGER",
    action: "VIEW",
  },
  "GET:/api/procurement/current-stock/batch-search": {
    skipAcl: false,
    resourceCode: "PROC_CURRENT_STOCK",
    action: "VIEW",
  },
  "GET:/api/procurement/current-stock/po-search": {
    skipAcl: false,
    resourceCode: "PROC_CURRENT_STOCK",
    action: "VIEW",
  },
  "GET:/api/procurement/current-stock": {
    skipAcl: false,
    resourceCode: "PROC_CURRENT_STOCK",
    action: "VIEW",
  },
  "GET:/api/procurement/current-stock/machine-wise": {
    skipAcl: false,
    resourceCode: "PROC_CURRENT_STOCK",
    action: "VIEW",
  },
  "GET:/api/procurement/stock-history": {
    skipAcl: false,
    resourceCode: "PROC_STOCK_HISTORY",
    action: "VIEW",
  },
  "GET:/api/procurement/stock-history/machine-wise": {
    skipAcl: false,
    resourceCode: "PROC_STOCK_HISTORY",
    action: "VIEW",
  },
  "GET:/api/procurement/reservations": {
    skipAcl: false,
    resourceCode: "PROC_RESERVATION_LIST",
    action: "VIEW",
  },
  "GET:/api/procurement/stock-valuation": {
    skipAcl: false,
    resourceCode: "PROC_STOCK_VALUATION",
    action: "VIEW",
  },
  ...
  "GET:/api/procurement/payment-terms": {
    skipAcl: false,
    resourceCode: "PROC_PAYMENT_TERMS_MASTER",
    action: "VIEW",
  },
  "POST:/api/procurement/payment-terms": {
    skipAcl: false,
    resourceCode: "PROC_PAYMENT_TERMS_MASTER",
    action: "WRITE",
  },
  "POST:/api/procurement/payment-terms/toggle": {
    skipAcl: false,
    resourceCode: "PROC_PAYMENT_TERMS_MASTER",
    action: "WRITE",
  },
  "GET:/api/procurement/reference-date-types": { skipAcl: true },
  "POST:/api/procurement/reference-date-type": {
    skipAcl: false,
    resourceCode: "PROC_PAYMENT_TERMS_MASTER",
    action: "WRITE",
  },
  "POST:/api/procurement/reference-date-type/toggle": {
    skipAcl: false,
    resourceCode: "PROC_PAYMENT_TERMS_MASTER",
    action: "WRITE",
  },
  "GET:/api/procurement/ports": {
    skipAcl: false,
    resourceCode: "PROC_PORT_MASTER",
    action: "VIEW",
  },
  "POST:/api/procurement/ports": {
    skipAcl: false,
    resourceCode: "PROC_PORT_MASTER",
    action: "WRITE",
  },
  "POST:/api/procurement/ports/toggle": {
    skipAcl: false,
    resourceCode: "PROC_PORT_MASTER",
    action: "WRITE",
  },
  "GET:/api/procurement/port-transit": {
    skipAcl: false,
    resourceCode: "PROC_PORT_TRANSIT_MASTER",
    action: "VIEW",
  },
  "POST:/api/procurement/port-transit": {
    skipAcl: false,
    resourceCode: "PROC_PORT_TRANSIT_MASTER",
    action: "WRITE",
  },
  "GET:/api/procurement/material-categories": {
    skipAcl: false,
    resourceCode: "PROC_MATERIAL_CATEGORY_MASTER",
    action: "VIEW",
  },
  "POST:/api/procurement/material-categories": {
    skipAcl: false,
    resourceCode: "PROC_MATERIAL_CATEGORY_MASTER",
    action: "WRITE",
  },
  "GET:/api/procurement/lead-times/import": {
    skipAcl: false,
    resourceCode: "PROC_IMPORT_LEAD_TIME_MASTER",
    action: "VIEW",
  },
  "POST:/api/procurement/lead-times/import": {
    skipAcl: false,
    resourceCode: "PROC_IMPORT_LEAD_TIME_MASTER",
    action: "WRITE",
  },
  "GET:/api/procurement/lead-times/domestic": {
    skipAcl: false,
    resourceCode: "PROC_DOMESTIC_LEAD_TIME_MASTER",
    action: "VIEW",
  },
  "POST:/api/procurement/lead-times/domestic": {
    skipAcl: false,
    resourceCode: "PROC_DOMESTIC_LEAD_TIME_MASTER",
    action: "WRITE",
  },
  "GET:/api/procurement/transporters": {
    skipAcl: false,
    resourceCode: "PROC_TRANSPORTER_MASTER",
    action: "VIEW",
  },
  "POST:/api/procurement/transporters": {
    skipAcl: false,
    resourceCode: "PROC_TRANSPORTER_MASTER",
    action: "WRITE",
  },
  "GET:/api/procurement/transporters/contacts": {
    skipAcl: false,
    resourceCode: "PROC_TRANSPORTER_MASTER",
    action: "VIEW",
  },
  "POST:/api/procurement/transporters/contacts": {
    skipAcl: false,
    resourceCode: "PROC_TRANSPORTER_MASTER",
    action: "EDIT",
  },
  "GET:/api/procurement/transporters/emails": {
    skipAcl: false,
    resourceCode: "PROC_TRANSPORTER_MASTER",
    action: "VIEW",
  },
  "POST:/api/procurement/transporters/emails": {
    skipAcl: false,
    resourceCode: "PROC_TRANSPORTER_MASTER",
    action: "EDIT",
  },
  "GET:/api/procurement/transporters/company-map": {
    skipAcl: false,
    resourceCode: "PROC_TRANSPORTER_MASTER",
    action: "VIEW",
  },
  "POST:/api/procurement/transporters/company-map": {
    skipAcl: false,
    resourceCode: "PROC_TRANSPORTER_MASTER",
    action: "EDIT",
  },
  ...
  "GET:/api/production/ac05-mts-sku-rates": {
    skipAcl: false,
    resourceCode: "ACC_AC05_MTS_SKU_COSTING",
    action: "VIEW",
  },
  "POST:/api/production/ac05-mts-sku-rates": {
    skipAcl: false,
    resourceCode: "ACC_AC05_MTS_SKU_COSTING",
    action: "WRITE",
  },
  "GET:/api/production/ac05-mts-sku-rates/vendor-codes": {
    skipAcl: false,
    resourceCode: "ACC_AC05_MTS_SKU_COSTING",
    action: "VIEW",
  },
  "GET:/api/production/ac05-mts-sku-rates/eligible-skus": {
    skipAcl: false,
    resourceCode: "ACC_AC05_MTS_SKU_COSTING",
    action: "VIEW",
  },
  "GET:/api/production/ac05-mts-sku-rates/pending-count": {
    skipAcl: false,
    resourceCode: "ACC_AC05_MTS_SKU_COSTING",
    action: "VIEW",
  },
  "GET:/api/production/ac05-mts-sku-rates/resolve": {
    skipAcl: false,
    resourceCode: "ACC_AC05_MTS_SKU_COSTING",
    action: "VIEW",
  },
  "GET:/api/production/ac06/workspace": {
    skipAcl: false,
    resourceCode: "ACC_SLOC_COSTING_GROUP",
    action: "VIEW",
  },
  "POST:/api/production/ac06/sloc-groups": {
    skipAcl: false,
    resourceCode: "ACC_SLOC_COSTING_SETUP",
    action: "WRITE",
  },
  "POST:/api/production/ac06/costing-groups": {
    skipAcl: false,
    resourceCode: "ACC_SLOC_COSTING_SETUP",
    action: "WRITE",
  },
  "POST:/api/production/ac06/costing-groups/assign": {
    skipAcl: false,
    resourceCode: "ACC_SLOC_COSTING_SETUP",
    action: "WRITE",
  },
  "POST:/api/production/ac06/costing-groups/unassign": {
    skipAcl: false,
    resourceCode: "ACC_SLOC_COSTING_SETUP",
    action: "WRITE",
  },
  "POST:/api/production/ac06/material-inclusion": {
    skipAcl: false,
    resourceCode: "ACC_SLOC_COSTING_SETUP",
    action: "WRITE",
  },
  "GET:/api/production/vendor-codes": {
    skipAcl: false,
    resourceCode: "SA_VENDOR_CODE_MASTER",
    action: "VIEW",
  },
  "POST:/api/production/vendor-codes": {
    skipAcl: false,
    resourceCode: "SA_VENDOR_CODE_MASTER",
    action: "WRITE",
  },
  "GET:/api/production/company-vendor-codes": {
    skipAcl: false,
    resourceCode: "ACC_COMPANY_VENDOR_CODE",
    action: "VIEW",
  },
  "POST:/api/production/company-vendor-codes/map": {
    skipAcl: false,
    resourceCode: "ACC_COMPANY_VENDOR_CODE",
    action: "WRITE",
  },
  "POST:/api/production/company-vendor-codes/primary": {
    skipAcl: false,
    resourceCode: "ACC_COMPANY_VENDOR_CODE",
    action: "WRITE",
  },
  "POST:/api/production/company-vendor-codes/unmap": {
    skipAcl: false,
    resourceCode: "ACC_COMPANY_VENDOR_CODE",
    action: "WRITE",
  },
  "POST:/api/production/company-vendor-codes/override": {
    skipAcl: false,
    resourceCode: "ACC_COMPANY_VENDOR_CODE",
    action: "WRITE",
  },
  "POST:/api/production/company-vendor-codes/override/delete": {
    skipAcl: false,
    resourceCode: "ACC_COMPANY_VENDOR_CODE",
    action: "WRITE",
  },
  "GET:/api/production/company-vendor-codes/for-so": {
    skipAcl: false,
    resourceCode: "PROC_SO_CREATE",
    action: "WRITE",
  },
  "POST:/api/production/ac06/rates": {
    skipAcl: false,
    resourceCode: "ACC_SLOC_COSTING_RATE",
    action: "WRITE",
  },
  "POST:/api/production/ac06/rates/split": {
    skipAcl: false,
    resourceCode: "ACC_SLOC_COSTING_RATE",
    action: "WRITE",
  },
  "POST:/api/production/ac06/rates/split/delete": {
    skipAcl: false,
    resourceCode: "ACC_SLOC_COSTING_RATE",
    action: "WRITE",
  },
  "POST:/api/production/ac06/verify": {
    skipAcl: false,
    resourceCode: "ACC_SLOC_COSTING_VERIFY",
    action: "WRITE",
  },
  "POST:/api/production/ac06/close": {
    skipAcl: false,
    resourceCode: "ACC_SLOC_COSTING_CLOSE",
    action: "WRITE",
  },
  "GET:/api/production/ac06/report": {
    skipAcl: false,
    resourceCode: "ACC_SLOC_COSTING_GROUP",
    action: "VIEW",
  },
  "GET:/api/production/ac06/history": {
    skipAcl: false,
    resourceCode: "ACC_SLOC_COSTING_GROUP",
    action: "VIEW",
  },
  // SO01 needs only the approved month labels while creating an order, not AC06 rates.
  "GET:/api/production/ac06/approved-months": {
    skipAcl: false,
    resourceCode: "PROC_SO_CREATE",
    action: "WRITE",
  },
  // AC07 Admixture Costing — read-only report, no write path (Manual month/Per Pack Qty recompute client-side only)
  "GET:/api/production/ac07/skus": {
    skipAcl: false,
    resourceCode: "ACC_AC07_ADMIX_COSTING",
    action: "VIEW",
  },
  "GET:/api/production/ac07/strokes": {
    skipAcl: false,
    resourceCode: "ACC_AC07_ADMIX_COSTING",
    action: "VIEW",
  },
  "GET:/api/production/ac07/months": {
    skipAcl: false,
    resourceCode: "ACC_AC07_ADMIX_COSTING",
    action: "VIEW",
  },
  "GET:/api/production/ac07/costing": {
    skipAcl: false,
    resourceCode: "ACC_AC07_ADMIX_COSTING",
    action: "VIEW",
  },
  "GET:/api/procurement/chas": {
    skipAcl: false,
    resourceCode: "PROC_CHA_MASTER",
    action: "VIEW",
  },
  "POST:/api/procurement/chas": {
    skipAcl: false,
    resourceCode: "PROC_CHA_MASTER",
    action: "WRITE",
  },
  "POST:/api/procurement/chas/toggle": {
    skipAcl: false,
    resourceCode: "PROC_CHA_MASTER",
    action: "EDIT",
  },
  "GET:/api/procurement/chas/contacts": {
    skipAcl: false,
    resourceCode: "PROC_CHA_MASTER",
    action: "VIEW",
  },
  "POST:/api/procurement/chas/contacts": {
    skipAcl: false,
    resourceCode: "PROC_CHA_MASTER",
    action: "EDIT",
  },
  "GET:/api/procurement/chas/emails": {
    skipAcl: false,
    resourceCode: "PROC_CHA_MASTER",
    action: "VIEW",
  },
  "POST:/api/procurement/chas/emails": {
    skipAcl: false,
    resourceCode: "PROC_CHA_MASTER",
    action: "EDIT",
  },
  "GET:/api/procurement/chas/company-map": {
    skipAcl: false,
    resourceCode: "PROC_CHA_MASTER",
    action: "VIEW",
  },
  "POST:/api/procurement/chas/company-map": {
    skipAcl: false,
    resourceCode: "PROC_CHA_MASTER",
    action: "EDIT",
  },
  ...
  // ── OM: Material ─────────────────────────────────────────────────────────
  "GET:/api/om/materials": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_LIST",
    action: "VIEW",
  },
  "POST:/api/om/material": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_CREATE",
    action: "WRITE",
  },
  "PATCH:/api/om/material": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_CREATE",
    action: "EDIT",
  },
  ...
  "PATCH:/api/om/material/category-group": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_CREATE",
    action: "WRITE",
  },
  "DELETE:/api/om/material/category-group": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_CREATE",
    action: "WRITE",
  },
  ...
  "DELETE:/api/om/material/category-group/member": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_CREATE",
    action: "WRITE",
  },
  "GET:/api/om/material/uom-conversions": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_LIST",
    action: "VIEW",
  },
  "POST:/api/om/material/uom-conversion": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_CREATE",
    action: "WRITE",
  },
  "PATCH:/api/om/material/uom-conversion": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_CREATE",
    action: "WRITE",
  },
  "POST:/api/om/material/status": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_CREATE",
    action: "EDIT",
  },
  "POST:/api/om/material/extend-company": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_CREATE",
    action: "WRITE",
  },
  "POST:/api/om/material/extend-plant": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_CREATE",
    action: "WRITE",
  },
  ...
  "GET:/api/om/material/company-extensions": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_LIST",
    action: "VIEW",
  },
  "GET:/api/om/material/plant-extensions": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_LIST",
    action: "VIEW",
  },
  "POST:/api/om/materials/bulk-save": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_CREATE",
    action: "WRITE",
  },
  "DELETE:/api/om/materials": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_CREATE",
    action: "WRITE",
  },
  "POST:/api/om/materials/import": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_CREATE",
    action: "WRITE",
  },
  "GET:/api/om/material/company-mapping": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_CREATE",
    action: "VIEW",
  },
  "POST:/api/om/material/company-map-bulk": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_CREATE",
    action: "WRITE",
  },
  "DELETE:/api/om/material/company-unmap-bulk": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_CREATE",
    action: "WRITE",
  },
  "POST:/api/om/material/company-mapping-import": {
    skipAcl: false,
    resourceCode: "OM_MATERIAL_CREATE",
    action: "WRITE",
  },
  ...
  "POST:/api/om/vendor/status": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_CREATE",
    action: "EDIT",
  },
  "DELETE:/api/om/vendors": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_CREATE",
    action: "WRITE",
  },
  "GET:/api/om/vendor/banks": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_LIST",
    action: "VIEW",
  },
  "POST:/api/om/vendor/banks": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_CREATE",
    action: "WRITE",
  },
  "GET:/api/om/vendor/contacts": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_LIST",
    action: "VIEW",
  },
  "POST:/api/om/vendor/contacts": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_CREATE",
    action: "WRITE",
  },
  "GET:/api/om/vendor/emails": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_LIST",
    action: "VIEW",
  },
  "POST:/api/om/vendor/emails": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_CREATE",
    action: "WRITE",
  },
  "GET:/api/om/vendor/company-mapping": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_LIST",
    action: "VIEW",
  },
  "POST:/api/om/vendor/company-map-bulk": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_CREATE",
    action: "WRITE",
  },
  "DELETE:/api/om/vendor/company-unmap-bulk": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_CREATE",
    action: "WRITE",
  },
  "POST:/api/om/vendor/company-map": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_CREATE",
    action: "WRITE",
  },
  "GET:/api/om/vendor/company-maps": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_LIST",
    action: "VIEW",
  },
  "GET:/api/om/vendor/payment-terms": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_LIST",
    action: "VIEW",
  },
  "POST:/api/om/vendor/payment-terms": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_CREATE",
    action: "WRITE",
  },
  "GET:/api/om/vendor-material-infos": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_LIST",
    action: "VIEW",
  },
  "GET:/api/om/vendor-material-info": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_LIST",
    action: "VIEW",
  },
  "GET:/api/om/vendor-material-info/mapped-materials": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_LIST",
    action: "VIEW",
  },
  "POST:/api/om/vendor-material-info": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_CREATE",
    action: "WRITE",
  },
  "PATCH:/api/om/vendor-material-info": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_CREATE",
    action: "EDIT",
  },
  "POST:/api/om/vendor-material-info/status": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_CREATE",
    action: "EDIT",
  },
  "DELETE:/api/om/vendor-material-info": {
    skipAcl: false,
    resourceCode: "OM_VENDOR_CREATE",
    action: "WRITE",
  },
  ...
  // ── OM: Customer ─────────────────────────────────────────────────────────
  "GET:/api/om/customers": {
    skipAcl: false,
    resourceCode: "OM_CUSTOMER_LIST",
    action: "VIEW",
  },
  "GET:/api/om/customer": {
    skipAcl: false,
  ...
  "POST:/api/om/customer": {
    skipAcl: false,
    resourceCode: "OM_CUSTOMER_CREATE",
    action: "WRITE",
  },
  "PATCH:/api/om/customer": {
    skipAcl: false,
    resourceCode: "OM_CUSTOMER_CREATE",
    action: "EDIT",
  },
  "POST:/api/om/customer/status": {
    skipAcl: false,
    resourceCode: "OM_CUSTOMER_CREATE",
    action: "EDIT",
  },
  "POST:/api/om/customer/company-map": {
    skipAcl: false,
    resourceCode: "OM_CUSTOMER_CREATE",
    action: "WRITE",
  },
  "GET:/api/om/customer/company-maps": {
    skipAcl: false,
    resourceCode: "OM_CUSTOMER_LIST",
    action: "VIEW",
  },
  "GET:/api/om/customer/gst-profile": {
    skipAcl: false,
    resourceCode: "OM_CUSTOMER_CREATE",
    action: "VIEW",
  },
  ...
  "GET:/api/om/parent-customers": {
    skipAcl: false,
    resourceCode: "OM_CUSTOMER_LIST",
    action: "VIEW",
  },
  "POST:/api/om/parent-customer": {
    skipAcl: false,
    resourceCode: "OM_CUSTOMER_CREATE",
    action: "WRITE",
  },
  "PATCH:/api/om/parent-customer": {
    skipAcl: false,
    resourceCode: "OM_CUSTOMER_CREATE",
    action: "EDIT",
  },
  ...
  "GET:/api/om/fg-parent-companies": {
    skipAcl: false,
    resourceCode: "OM_CUSTOMER_LIST",
    action: "VIEW",
  },
  "POST:/api/om/fg-parent-company": {
    skipAcl: false,
    resourceCode: "OM_CUSTOMER_CREATE",
    action: "WRITE",
  },
  "PATCH:/api/om/fg-parent-company": {
    skipAcl: false,
    resourceCode: "OM_CUSTOMER_CREATE",
    action: "EDIT",
  },
  ...
  "GET:/api/om/fg-parent-company/by-gst": {
    skipAcl: false,
    resourceCode: "OM_CUSTOMER_LIST",
    action: "VIEW",
  },
  "GET:/api/om/fg-depot-codes": {
    skipAcl: false,
    resourceCode: "OM_CUSTOMER_LIST",
    action: "VIEW",
  },
  "POST:/api/om/fg-depot-code": {
    skipAcl: false,
    resourceCode: "OM_CUSTOMER_CREATE",
    action: "WRITE",
  },
  "PATCH:/api/om/fg-depot-code": {
    skipAcl: false,
    resourceCode: "OM_CUSTOMER_CREATE",
    action: "EDIT",
  },
  ...
  "GET:/api/om/customer-addresses": {
    skipAcl: false,
    resourceCode: "OM_CUSTOMER_LIST",
    action: "VIEW",
  },
  "POST:/api/om/customer-address": {
    skipAcl: false,
    resourceCode: "OM_CUSTOMER_CREATE",
    action: "WRITE",
  },
  "PATCH:/api/om/customer-address": {
    skipAcl: false,
    resourceCode: "OM_CUSTOMER_CREATE",
    action: "EDIT",
  },
  "PATCH:/api/om/customer-addresses/bulk-map": {
    skipAcl: false,
    resourceCode: "OM_CUSTOMER_CREATE",
    action: "EDIT",
  },
  ...
  "GET:/api/production/pack-codes": {
    skipAcl: false,
    resourceCode: "PROD_PO_CREATE",
    action: "VIEW",
  },
  "POST:/api/production/pack-codes": {
    skipAcl: false,
    resourceCode: "SA_OM_PACK_CODE_MASTER",
    action: "WRITE",
  },
  ...
  "GET:/api/production/pack-configs": {
    skipAcl: false,
    resourceCode: "SA_OM_PACK_CODE_MASTER",
    action: "VIEW",
  },
  ...
  "GET:/api/production/batch-series": {
    skipAcl: false,
    resourceCode: "SA_PROD_BATCH_SERIES",
    action: "VIEW",
  },
  ...
  "GET:/api/production/batch-numbers": {
    skipAcl: false,
    resourceCode: "PROD_BATCH_RELEASE",
    action: "VIEW",
  },
  ...
  "GET:/api/production/mts-batch-range-check": {
    skipAcl: false,
    resourceCode: "PROD_PO_CREATE",
    action: "VIEW",
  },
  ...
  "POST:/api/production/mts-creation/material-plan": {
    skipAcl: false,
    resourceCode: "PROD_PO_CREATE",
    action: "VIEW",
  },
  "POST:/api/production/mts-creation/packing-plan": {
    skipAcl: false,
    resourceCode: "PROD_PO_CREATE",
    action: "VIEW",
  },
  "POST:/api/production/mts-creation/packing-combine": {
    skipAcl: false,
    resourceCode: "PROD_PO_CREATE",
    action: "VIEW",
  },
  "POST:/api/production/mts-creation/commit": {
    skipAcl: false,
    resourceCode: "PROD_PO_CREATE",
    action: "WRITE",
  },
  ...
  "GET:/api/production/segment-locations": {
    skipAcl: false,
    resourceCode: "SA_PROD_SEGMENT_LOCATIONS",
    action: "VIEW",
  },
  "POST:/api/production/segment-locations": {
    skipAcl: false,
    resourceCode: "SA_PROD_SEGMENT_LOCATIONS",
    action: "WRITE",
  },
  "GET:/api/production/conversion-rates": {
    skipAcl: false,
    resourceCode: "ACC_CONVERSION_COST",
    action: "VIEW",
  },
  ...
  "GET:/api/production/conversion-rate-prodshades": {
    skipAcl: false,
    resourceCode: "ACC_CONVERSION_COST",
    action: "VIEW",
  },
  ...
  "GET:/api/production/derived-opening-rate": {
    skipAcl: false,
    resourceCode: "PROC_OPENING_STOCK_LIST",
    action: "VIEW",
  },
  ...
  "GET:/api/production/mts-current-stroke": {
    skipAcl: false,
    resourceCode: "PROD_STROKE_MASTER",
    action: "VIEW",
  },
  ...
  "GET:/api/production/plan-feed": {
    skipAcl: false,
    resourceCode: "PROD_PLAN_FEED",
    action: "VIEW",
  },
  ...
  "GET:/api/production/plan-feed/summary": {
    skipAcl: false,
    resourceCode: "PROD_PLAN_FEED",
    action: "VIEW",
  },
  "GET:/api/production/plan-feed/unmapped-stock": {
    skipAcl: false,
    resourceCode: "PROD_PLAN_FEED",
    action: "VIEW",
  },
  "GET:/api/production/plan-feed/check-stroke": {
    skipAcl: false,
    resourceCode: "PROD_PLAN_FEED",
    action: "VIEW",
  },
  "GET:/api/production/plan-feed/stroke-options": {
    skipAcl: false,
    resourceCode: "PROD_PLAN_FEED",
    action: "VIEW",
  },
  "GET:/api/production/plan-feed/find": {
    skipAcl: false,
    resourceCode: "PROD_PLAN_FEED",
    action: "VIEW",
  },
  "GET:/api/production/plan-feed/mtest-skus": {
    skipAcl: false,
    resourceCode: "PROD_PLAN_FEED",
    action: "VIEW",
  },
  ...
  "GET:/api/production/mtest-skus": {
    skipAcl: false,
    resourceCode: "PROD_PO_CREATE",
    action: "VIEW",
  },
  "GET:/api/production/plan-feed/mtest-capability": {
    skipAcl: false,
    resourceCode: "PROD_PLAN_FEED",
    action: "VIEW",
  },
  ...
  "GET:/api/production/order-information-system": {
    skipAcl: false,
    resourceCode: "PROD_ORDER_INFO_SYSTEM",
    action: "VIEW",
  },
  ...
  "GET:/api/production/batch-variance-report": {
    skipAcl: false,
    resourceCode: "PROD_BATCH_VARIANCE",
    action: "VIEW",
  },
  ...
  "GET:/api/production/rm-pm-sale-report": {
    skipAcl: false,
    resourceCode: "PROD_RM_PM_SALE_REPORT",
    action: "VIEW",
  },
  "GET:/api/production/excess-consumption-report": {
    skipAcl: false,
    resourceCode: "PROD_EXCESS_CONSUMPTION_REPORT",
    action: "VIEW",
  },
  "GET:/api/production/process-orders": {
    skipAcl: false,
    resourceCode: "PROD_ORDER_LIST",
    action: "VIEW",
  },
  "GET:/api/production/process-orders/availability-preview": {
    skipAcl: false,
    resourceCode: "PROD_ORDER_LIST",
    action: "VIEW",
  },
  ...
  "POST:/api/production/process-orders/mtest": {
    skipAcl: false,
    resourceCode: "PROD_MTEST_PO_CREATE",
    action: "WRITE",
  },
  "GET:/api/production/packing-orders": {
    skipAcl: false,
    resourceCode: "PROD_ORDER_LIST",
    action: "VIEW",
  },
  "GET:/api/production/packing-orders/availability-preview": {
    skipAcl: false,
    resourceCode: "PROD_ORDER_LIST",
    action: "VIEW",
  },
  "GET:/api/production/packing-orders/sfg-batches": {
    skipAcl: false,
    resourceCode: "PROD_ORDER_LIST",
    action: "VIEW",
  },
  ...
  "GET:/api/production/packing-orders/mtest-sfg-options": {
    skipAcl: false,
    resourceCode: "PROD_ORDER_LIST",
    action: "VIEW",
  },
  ...
  "POST:/api/production/packing-orders/mtest": {
    skipAcl: false,
    resourceCode: "PROD_MTEST_PACK_PO_CREATE",
    action: "WRITE",
  },
  "GET:/api/production/fg-stock-breakdown": {
    skipAcl: false,
    resourceCode: "PROD_FG_STOCK_BREAKDOWN",
    action: "VIEW",
  },
  ...
  "GET:/api/production/sfg-qa-documents": {
    skipAcl: false,
    resourceCode: "PROD_SFG_RESULT_RECORDING",
    action: "VIEW",
  },
  "GET:/api/production/stroke-change-requests": {
    skipAcl: false,
    resourceCode: "PROD_CHANGE_BOM_ITEM_APPROVAL",
    action: "VIEW",
  },
  "POST:/api/production/stroke-change-requests": {
    skipAcl: false,
    resourceCode: "PROD_CHANGE_BOM_ITEM",
    action: "WRITE",
  },
  "GET:/api/production/pack-boms/eligible-skus": {
    skipAcl: false,
    resourceCode: "PROD_PACK_BOM_CREATE",
    action: "VIEW",
  },
  ...
  "GET:/api/production/pack-bom-change-requests": {
    skipAcl: false,
    resourceCode: "PROD_CHANGE_PACK_BOM_APPROVAL",
    action: "VIEW",
  },
  "GET:/api/production/partial-reversals/prodshades": {
    skipAcl: false,
    resourceCode: "PROD_PARTIAL_BATCH_REVERSAL",
    action: "VIEW",
  },
  "GET:/api/production/partial-reversals/resolve-batch": {
    skipAcl: false,
    resourceCode: "PROD_PARTIAL_BATCH_REVERSAL",
    action: "VIEW",
  },
  "GET:/api/production/partial-reversals/stock-lines": {
    skipAcl: false,
    resourceCode: "PROD_PARTIAL_BATCH_REVERSAL",
    action: "VIEW",
  },
  "GET:/api/production/partial-reversals/salvage-batches": {
    skipAcl: false,
    resourceCode: "PROD_PARTIAL_BATCH_REVERSAL",
    action: "VIEW",
  },
  "GET:/api/production/partial-reversals/detail": {
    skipAcl: false,
    resourceCode: "PROD_PARTIAL_BATCH_REVERSAL",
    action: "VIEW",
  },
  ...
  "GET:/api/production/partial-reversals": {
    skipAcl: false,
    resourceCode: "PROD_PARTIAL_REVERSAL_REPORT",
    action: "VIEW",
  },
  // §104.9 Opening Genealogy — Production ACL (PR22/PR23)
  "POST:/api/production/old-process-po": {
    skipAcl: false,
    resourceCode: "PROD_OLD_PROCESS_PO",
    action: "WRITE",
  },
  "GET:/api/production/old-process-po/batches": {
    skipAcl: false,
    resourceCode: "PROD_OLD_PACKING_PO",
    action: "VIEW",
  },
  "POST:/api/production/old-packing-po": {
    skipAcl: false,
    resourceCode: "PROD_OLD_PACKING_PO",
    action: "WRITE",
  },
  "GET:/api/production/old-packing-po/batches": {
    skipAcl: false,
    resourceCode: "PROD_OLD_PACKING_PO",
    action: "VIEW",
  },
...
const PATTERN_ROUTE_ACL: PatternAclEntry[] = [
  ...
  },
  {
    ...
    methods: {
      POST: { skipAcl: false, resourceCode: "PROC_PO_CREATE", action: "EDIT" },
    },
  },
  {
  ...
  },
  {
    ...
    methods: {
      POST: { skipAcl: false, resourceCode: "PROC_GRN_LIST", action: "DELETE" },
    },
  },
  ...
  // ── Inward QA ────────────────────────────────────────────────────────────
  {
    ...
    methods: {
      GET: { skipAcl: false, resourceCode: "PROC_QA_QUEUE", action: "VIEW" },
    },
  },
  {
    pattern: /^\/api\/procurement\/qa-documents\/[^/]+\/test-lines$/,
    methods: {
      POST: { skipAcl: false, resourceCode: "PROC_QA_QUEUE", action: "WRITE" },
    },
  },
  {
    pattern: /^\/api\/procurement\/qa-documents\/[^/]+\/test-lines\/[^/]+$/,
  ...
  },
  {
    ...
    methods: {
      POST: { skipAcl: false, resourceCode: "PROC_IV_CREATE", action: "WRITE" },
    },
  },
  {
    pattern: /^\/api\/procurement\/invoice-verifications\/[^/]+\/lines\/[^/]+$/,
  ...
  // separate resourceCode — see the exact-match block above for why) ────────
  {
    ...
    methods: {
      POST: { skipAcl: false, resourceCode: "PROC_IV_LIST", action: "WRITE" },
    },
  },
  {
  ...
  },
  {
    ...
    methods: {
      POST: { skipAcl: false, resourceCode: "PROC_LC_LIST", action: "WRITE" },
    },
  },
  {
    pattern: /^\/api\/procurement\/landed-costs\/[^/]+\/lines\/[^/]+$/,
  ...
  },
  {
    ...
    methods: {
      POST: { skipAcl: false, resourceCode: "PROC_LC_LIST", action: "APPROVE" },
    },
  },
  ...
  },
  {
    ...
    methods: {
      PUT: { skipAcl: false, resourceCode: "PROC_GATE_EXIT", action: "EDIT" },
    },
  },
  {
  ...
  },
  {
    ...
    methods: {
      POST: { skipAcl: false, resourceCode: "PROC_STO_CREATE", action: "EDIT" },
    },
  },
  {
  ...
  },
  {
    ...
    methods: {
      POST: { skipAcl: false, resourceCode: "PROC_SO_CREATE", action: "EDIT" },
    },
  },
  {
  ...
  },
  {
    ...
    methods: {
      POST: { skipAcl: false, resourceCode: "PROC_SO_LIST", action: "EDIT" },
    },
  },
  {
  ...
  },
  {
    ...
    methods: {
      GET: { skipAcl: false, resourceCode: "PROC_INV_LIST", action: "VIEW" },
    },
  },
  {
    pattern:
      /^\/api\/procurement\/delivery-orders-v2\/[^/]+\/pgi-invoice-groups$/,
    methods: {
      POST: { skipAcl: false, resourceCode: "PROC_INV_LIST", action: "WRITE" },
    },
  },
  {
    ...
    methods: {
      POST: { skipAcl: false, resourceCode: "PROC_INV_LIST", action: "EDIT" },
    },
  },
  {
  ...
  },
  {
    ...
    methods: {
      POST: { skipAcl: false, resourceCode: "PROC_DO_CREATE", action: "EDIT" },
    },
  },
  {
  ...
  },
  {
    ...
    methods: {
      POST: { skipAcl: false, resourceCode: "PROC_SO_CREATE", action: "WRITE" },
    },
  },
  {
    pattern: /^\/api\/procurement\/sales-orders\/[^/]+\/lines$/,
    methods: {
      PATCH: { skipAcl: false, resourceCode: "PROC_SO_CREATE", action: "EDIT" },
    },
  },
  {
    pattern:
      /^\/api\/procurement\/sales-orders\/[^/]+\/lines\/[^/]+\/knock-off$/,
    methods: {
      POST: { skipAcl: false, resourceCode: "PROC_SO_CREATE", action: "EDIT" },
    },
  },
  ...
  },
  {
    ...
    methods: {
      POST: {
        skipAcl: false,
        resourceCode: "PROC_LOC_TRANSFER_REVERSE",
        action: "WRITE",
      },
    },
  },
  {
    pattern:
      /^\/api\/procurement\/stock-status-change\/postings\/[^/]+\/approve$/,
    methods: {
      POST: {
        skipAcl: false,
        resourceCode: "PROD_STOCK_STATUS_CHANGE",
  ...
  {
    pattern:
      /^\/api\/procurement\/stock-status-change\/postings\/[^/]+\/reverse$/,
    methods: {
      POST: {
        skipAcl: false,
        resourceCode: "PROD_STOCK_STATUS_CHANGE",
  ...
  },
  {
    ...
    methods: {
      GET: { skipAcl: false, resourceCode: "PROC_PI_LIST", action: "VIEW" },
    },
  },
  {
  ...
  {
    pattern:
      /^\/api\/procurement\/physical-inventory\/[^/]+\/recount-workspace$/,
    methods: {
      GET: { skipAcl: false, resourceCode: "PROC_PI_RECOUNT", action: "VIEW" },
    },
  },
  {
    ...
    methods: {
      POST: { skipAcl: false, resourceCode: "PROC_PI_LIST", action: "EDIT" },
    },
  },
  {
    ...
    pattern: /^\/api\/procurement\/physical-inventory\/[^/]+\/items\/[^/]+$/,
    methods: {
      DELETE: { skipAcl: false, resourceCode: "PROC_PI_LIST", action: "EDIT" },
    },
  },
  {
    ...
    pattern:
      /^\/api\/procurement\/physical-inventory\/[^/]+\/items\/[^/]+\/count$/,
    methods: {
      PUT: {
        skipAcl: false,
        resourceCode: "PROC_PI_COUNT_ENTRY",
  ...
  },
  {
    ...
    methods: {
      PUT: { skipAcl: false, resourceCode: "PROC_PI_RECOUNT", action: "WRITE" },
    },
  },
  {
    ...
    methods: {
      POST: { skipAcl: false, resourceCode: "PROC_PI_LIST", action: "WRITE" },
    },
  },
  {
  ...
  },
  {
    ...
    methods: {
      POST: { skipAcl: false, resourceCode: "PROC_PI_LIST", action: "APPROVE" },
    },
  },
  {
  ...
  {
    pattern:
      /^\/api\/procurement\/number-series\/company\/[^/]+\/[^/]+\/counters$/,
    methods: {
      GET: { skipAcl: true },
      POST: { skipAcl: true },
    },
  ...
  },
  {
    ...
    methods: {
      POST: {
        skipAcl: false,
        resourceCode: "PROD_STROKE_APPROVAL",
        action: "APPROVE",
      },
    },
  },
  ...
  },
  {
    ...
    methods: {
      POST: {
        skipAcl: false,
        resourceCode: "PROD_MTEST_PLAN_FEED",
        action: "EDIT",
      },
    },
  },
  ...
  },
  {
    ...
    methods: {
      GET: { skipAcl: false, resourceCode: "PROD_ORDER_LIST", action: "VIEW" },
    },
  },
  {
    pattern: /^\/api\/production\/process-orders\/[^/]+\/lines$/,
    methods: {
      PATCH: { skipAcl: false, resourceCode: "PROD_PO_EDIT", action: "EDIT" },
    },
  },
  {
  ...
  },
  {
    ...
    methods: {
      POST: {
        skipAcl: false,
        resourceCode: "PROD_MTEST_START_BATCH",
        action: "WRITE",
      },
    },
  },
  {
    ...
    methods: {
      POST: { skipAcl: false, resourceCode: "PROD_PO_FINAL", action: "WRITE" },
    },
  },
  {
    ...
    methods: {
      POST: {
        skipAcl: false,
        resourceCode: "PROD_MTEST_PO_FINAL",
        action: "WRITE",
      },
    },
  },
  ...
  },
  {
    ...
    methods: {
      POST: { skipAcl: false, resourceCode: "PROD_PO_EDIT", action: "EDIT" },
    },
  },
  {
  ...
  },
  {
    ...
    methods: {
      POST: {
        skipAcl: false,
        resourceCode: "PROD_MTEST_PACK_PO_FINAL",
        action: "WRITE",
      },
    },
  },
  ...
  },
  {
    ...
    methods: {
      POST: {
        skipAcl: false,
        resourceCode: "PROD_PACK_BOM_APPROVAL",
        action: "APPROVE",
      },
    },
  },
  ...
  },
  {
    ...
    methods: {
      POST: {
        skipAcl: false,
        resourceCode: "PROD_CHANGE_PACK_BOM",
        action: "WRITE",
      },
    },
  },
  ...
  // ── OM: Vendor (parametric) ────────────────────────────────────────────────
  {
    ...
    methods: {
      GET: { skipAcl: false, resourceCode: "OM_VENDOR_LIST", action: "VIEW" },
    },
  },
  {
  ...
  // ── OM: Customer (parametric) ──────────────────────────────────────────────
  {
    ...
    methods: {
      GET: { skipAcl: false, resourceCode: "OM_CUSTOMER_LIST", action: "VIEW" },
    },
  },
  {
