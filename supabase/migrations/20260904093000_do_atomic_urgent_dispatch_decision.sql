-- §136 (2026-09-04) -- carry the new urgent_dispatch_decision (YES/NO/NULL)
-- column through the DO Create/Edit atomic RPC. Presentation/decision-only
-- at this stage -- the actual PGI posting-date bypass reads it later.
