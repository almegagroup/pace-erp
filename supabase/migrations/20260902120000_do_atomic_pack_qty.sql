-- Carry the new pack_qty/pack_uom_code columns (20260902110000) through the
-- DO Create/Edit atomic RPC. Presentation-only, same as display_rate_basis
-- above it -- unit_value/quantity/gst_amount/line_total are unchanged.
