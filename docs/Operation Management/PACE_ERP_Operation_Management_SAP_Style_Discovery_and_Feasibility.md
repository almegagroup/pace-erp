...
- ⏳ বাকি: live end-to-end verification deployed app-এ (business owner login লাগবে) — SFG থেকে FG পর্যন্ত পুরো chain-এর real ৩-level example Dev-এ পাওয়া যায়নি (যতটুকু SFG batch আছে তার কোনোটাই এখনো real Packing PO দিয়ে consume হয়নি), তাই ৩ নম্বর level (SFG→FG)-এর কোড path টাইপ-সঠিক ও ২-level-এর mirror হলেও, বাস্তব ৩-level chain দিয়ে এখনো test হয়নি।
