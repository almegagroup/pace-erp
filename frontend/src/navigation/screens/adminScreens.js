...
export const ADMIN_SCREENS = Object.freeze({
  ...
  SA_USER_SCOPE_REPORT: {
    screen_code: "SA_USER_SCOPE_REPORT",
    route: "/sa/users/report",
    universe: "ADMIN",
    type: SCREEN_TYPE.FULL,
    keepAlive: false,
  },
  ...
  SA_ACL_VERSION_CENTER: {
    screen_code: "SA_ACL_VERSION_CENTER",
  ...
  SA_VENDOR_DETAIL: {
    screen_code: "SA_VENDOR_DETAIL",
    route: "/sa/om/vendor/detail",
    universe: "ADMIN",
    type: SCREEN_TYPE.FULL,
    keepAlive: false,
  },
