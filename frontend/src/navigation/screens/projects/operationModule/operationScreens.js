...
export const OPERATION_SCREENS = Object.freeze({
  ...
  PROC_STOCK_HISTORY: {
    screen_code: "PROC_STOCK_HISTORY",
    route: "/dashboard/procurement/reports/stock-history",
    universe: "ACL",
    type: SCREEN_TYPE.FULL,
    keepAlive: false,
  },
  ...
  PROD_STOCK_STATUS_CHANGE: {
    screen_code: "PROD_STOCK_STATUS_CHANGE",
    route: "/dashboard/procurement/stock-status-change",
    universe: "ACL",
    type: SCREEN_TYPE.FULL,
    keepAlive: false,
  },
  ...
  ACC_AC05_MTS_SKU_COSTING: {
    screen_code: "ACC_AC05_MTS_SKU_COSTING",
    route: "/dashboard/production/ac05-mts-sku-costing",
    universe: "ACL",
    type: SCREEN_TYPE.FULL,
    keepAlive: false,
  },
