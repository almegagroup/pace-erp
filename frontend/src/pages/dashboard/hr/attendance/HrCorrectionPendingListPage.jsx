/*
 * File-ID: 8.5D-HR-CORR-PENDING-LIST
 * File-Path: frontend/src/pages/dashboard/hr/attendance/HrCorrectionPendingListPage.jsx
 * Gate: 8
 * Phase: 5-D-3
 * Domain: HR
 * Purpose: HR's own submitted correction requests — list view with status.
 *          Clicking a row navigates to HrCorrectionRequestDetailPage.
 * Authority: Frontend
 */
...
export default function HrCorrectionPendingListPage() {
  ...
  function openDetail(row) {
    openScreenWithContext("HR_ATTENDANCE_CORRECTION_REQUEST_DETAIL", { request: row, mode: "myRequests" });
  }
            ...
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50">
                  ...
                  <th className="px-3 py-2 text-left text-[10px] font-semibold uppercase tracking-[0.14em] text-slate-500">Submitted</th>
