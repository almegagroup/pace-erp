...
// Parent Company is a global master (no per-company mapping) -- this finds an
// existing one by GST so the create form can offer "use this" instead of
// creating a duplicate for the same real-world GST.
