...
export default function SO05InvoicePostingPage() {
  ...
  return <ErpScreenScaffold title="Sales Return Invoice Posting" eyebrow="SO05 · Accounts" subtitle="Complete deferred invoice details. This does not create a payable document." actions={[{ label: "Back to receipts", tone: "neutral", onClick: () => navigate("/dashboard/procurement/sales/sales-return") }]}>
