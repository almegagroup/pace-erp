  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // listPorts() already unwraps to the bare array (fetchProcurement's
        // generic {data:[...]} unwrap) -- this used to read a non-existent
        // .data property off that array, so portsById never got populated
